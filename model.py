...
class DiffusersModel:
    ...
    def activate(self):
        ...
        model_dir = "models/Deliberate"
        self.pipe = TensorRTStableDiffusionPipeline.from_pretrained(
            model_id="",
            engine_dir=os.path.join("models/Deliberate", "engine"),
            device=torch.device("cuda"),
            max_batch_size=1
        )

    def create_scheduler(self, scheduler_name: str):
        return SCHEDULERS[scheduler_name].from_pretrained("models/Deliberate", subfolder="scheduler")
